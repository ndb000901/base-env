...
services:
  coms.rabbitmq.i1:
    ...
    image: rabbitmq:4.1.0-management # 镜像
    ...
    #   - "15671:15671"
    volumes: # 挂载目录
      - rabbitmq_i1_config:/etc/rabbitmq
      - rabbitmq_i1_data:/var/lib/rabbitmq
      - rabbitmq_i1_log:/var/log/rabbitmq
  ...
  coms.rabbitmq.i2:
    ...
    # - "15673:15672"
    volumes: # 挂载目录
      - rabbitmq_i2_config:/etc/rabbitmq
      - rabbitmq_i2_data:/var/lib/rabbitmq
      - rabbitmq_i2_log:/var/log/rabbitmq
  ...
  coms.rabbitmq.i3:
    ...
    #   - "5674:5672"
      # - "15674:15672"
    volumes: # 挂载目录
      - rabbitmq_i3_config:/etc/rabbitmq
      - rabbitmq_i3_data:/var/lib/rabbitmq
      - rabbitmq_i3_log:/var/log/rabbitmq
...
## 3. /var/lib/rabbitmq/.erlang.cookie
...
#
cp coms-rabbitmq_rabbitmq_i1_data/_data/.erlang.cookie coms-rabbitmq_rabbitmq_i2_data/_data/.erlang.cookie
cp coms-rabbitmq_rabbitmq_i1_data/_data/.erlang.cookie coms-rabbitmq_rabbitmq_i3_data/_data/.erlang.cookie
```
...
`rabbitmq.hello.work.conf`

```conf
server {

    listen 443 ssl;
    server_name rabbitmq.hello.work;

    ssl_certificate     certs/server-rabbitmq.hello.work.fullchain.pem;
    ssl_certificate_key certs/rabbitmq.hello.work.key.pem;
    ...
    location / {
        proxy_pass http://coms.rabbitmq.i1:15672;
...
# management.ssl.certfile   = /etc/rabbitmq/rabbitmq.hello.work.fullchain.pem
# management.ssl.keyfile    = /etc/rabbitmq/rabbitmq.hello.work.key.pem
